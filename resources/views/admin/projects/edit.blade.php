...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-secondary">Edit Project</h2>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title"
                            placeholder="e.g. Portfolio Vue/Laravel" value="{{ old('title', $project->title) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" name="title_en" id="title_en"
                            placeholder="e.g. Portfolio Vue/Laravel (English)" value="{{ old('title_en', $project->title_en) }}">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('git') is-invalid @enderror" name="git"
                            id="git" placeholder="https://github.com/username/repo" value="{{ old('git', $project->git) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="content" rows="5" placeholder="Project description...">{{ old('content', $project->content) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('content_en') is-invalid @enderror" name="content_en" id="content_en" rows="5" placeholder="Project description (English)...">{{ old('content_en', $project->content_en) }}</textarea>
